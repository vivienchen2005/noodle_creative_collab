...
let Process3DNode = (() => {
    ...
    var Process3DNode = _classThis = class extends _classSuper {
        ...
        connectImageInput(sourceNode, sourceButtonId = "") {
            ...
            const imageGenNode = sourceNode.getComponent(ProcessImageGenNode_1.ProcessImageGenNode.getTypeName());
        ...
        getImageInputData() {
            ...
            const imageGenNode = this._connectedImageNode.getComponent(ProcessImageGenNode_1.ProcessImageGenNode.getTypeName());
            if (imageGenNode) {
         ...
         */
        checkCredentials(needsGoogle = false, needsSnap = false) {
            if (needsGoogle) {
            ...
            if (needsSnap) {
                const snapToken = RemoteServiceGatewayCredentials_1.RemoteServiceGatewayCredentials.getApiToken(RemoteServiceGatewayCredentials_2.AvaliableApiTypes.Snap);
