    ...
    var InputNodePrompt = _classThis = class extends _classSuper {
        ...
        findOrCreateConnectionController() {
            ...
            for (let i = 0; i < rootObjects; i++) {
                ...
                const controller = rootObject.getComponent(NodeConnectionController_1.NodeConnectionController.getTypeName());
                if (controller) {
            ...
            const controller = controllerObject.createComponent(NodeConnectionController_1.NodeConnectionController.getTypeName());
            if (controller) {
