...
export class NodeConnection extends BaseScriptComponent {
    ...
    serialize(): any {
        ...
        const sourceBaseNode = sourcePointComp?.parentNode?.getComponent(BaseNode.getTypeName()) as BaseNode;
        const targetBaseNode = targetPointComp?.parentNode?.getComponent(BaseNode.getTypeName()) as BaseNode;
