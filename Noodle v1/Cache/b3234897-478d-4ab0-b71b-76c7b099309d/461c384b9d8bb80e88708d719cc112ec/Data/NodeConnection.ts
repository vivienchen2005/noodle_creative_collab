...
export class NodeConnection extends BaseScriptComponent {
    ...
    serialize(): any {
        ...
        const sourceBaseNode = sourcePointComp?.parentNode?.getComponent(BaseNode.getTypeName() as any) as BaseNode | null;
        const targetBaseNode = targetPointComp?.parentNode?.getComponent(BaseNode.getTypeName() as any) as BaseNode | null;
