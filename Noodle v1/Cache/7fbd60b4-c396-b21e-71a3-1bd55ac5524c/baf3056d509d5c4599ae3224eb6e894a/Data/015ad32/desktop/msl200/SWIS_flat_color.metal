...
//float4 mask_1 4400
//float4 mask2 4416
//float Port_Rotation_N002 4432
//float2 Port_Center_N002 4440
//float Port_Position1_N003 4448
//float Port_Position2_N003 4452
//float4 Port_Value2_N003 4464
//float Port_Position3_N003 4480
//float4 Port_Value3_N003 4496
//float Port_Position4_N003 4512
//float depthRef 4516
//}
...
float param_3=(*sc_set0.UserUniforms).Port_Rotation_N002;
float2 param_4=(*sc_set0.UserUniforms).Port_Center_N002;
float l9_1=sin(radians(param_3));
float l9_2=cos(radians(param_3));
float2 param_5=param_2-param_4;
param_5=float2(dot(float2(l9_2,l9_1),param_5),dot(float2(-l9_1,l9_2),param_5))+param_4;
CoordsOut_N2=param_5;
float4 Output_N5=float4(0.0);
float4 param_6=(*sc_set0.UserUniforms).mask_1;
Output_N5=param_6;
float4 Output_N7=float4(0.0);
float4 param_7=(*sc_set0.UserUniforms).mask2;
Output_N7=param_7;
float4 Value_N3=float4(0.0);
float param_8=CoordsOut_N2.x;
float4 param_9=Output_N5;
float param_10=(*sc_set0.UserUniforms).Port_Position1_N003;
float4 param_11=Output_N7;
float param_12=(*sc_set0.UserUniforms).Port_Position2_N003;
float4 param_13=(*sc_set0.UserUniforms).Port_Value2_N003;
float param_14=(*sc_set0.UserUniforms).Port_Position3_N003;
float4 param_15=(*sc_set0.UserUniforms).Port_Value3_N003;
float param_16=(*sc_set0.UserUniforms).Port_Position4_N003;
float4 param_17=Output_N7;
float4 param_18=Output_N5;
param_8=fast::clamp(param_8,0.0,1.0);
float4 param_19;
if (param_8<param_10)
{
param_19=mix(param_9,param_11,float4(fast::clamp(param_8/param_10,0.0,1.0)));
}
else
{
if (param_8<param_12)
{
param_19=mix(param_11,param_13,float4(fast::clamp((param_8-param_10)/(param_12-param_10),0.0,1.0)));
}
else
{
if (param_8<param_14)
{
param_19=mix(param_13,param_15,float4(fast::clamp((param_8-param_12)/(param_14-param_12),0.0,1.0)));
}
else
{
if (param_8<param_16)
{
param_19=mix(param_15,param_17,float4(fast::clamp((param_8-param_14)/(param_16-param_14),0.0,1.0)));
}
else
{
param_19=mix(param_17,param_18,float4(fast::clamp((param_8-param_16)/(1.0-param_16),0.0,1.0)));
}
}
}
}
...
float4 l9_6=fast::max(param_21,float4(0.0));
float4 param_22=l9_6;
if (sc_ShaderCacheConstant_tmp!=0)
{
