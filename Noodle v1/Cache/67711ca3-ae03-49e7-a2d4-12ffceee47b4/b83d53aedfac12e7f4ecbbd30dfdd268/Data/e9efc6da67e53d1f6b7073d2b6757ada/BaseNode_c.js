...
// @input vec2 frameSize = {20,20} {"hint":"Fixed size for the frame (in centimeters)"}
// @input string nodeType = "Base" {"hint":"Type identifier for this node"}
