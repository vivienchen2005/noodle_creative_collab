...
export class BaseNode extends BaseScriptComponent {
    ...
    private _frameSize: vec2 = new vec2(20, 20);
            ...
            this.createEvent("UpdateEvent").bind(() => {
                if (this._frameComponent && !this._initialized) {
                    ...
                    if (this._frameComponent.roundedRectangle) {
                        // Now it's safe to set innerSize - use the setter to ensure it's updated
                        this._frameComponent.innerSize = this._frameSize;
                        print(`BaseNode: Frame initialized, set size to ${this._frameSize.x}x${this._frameSize.y}`);
