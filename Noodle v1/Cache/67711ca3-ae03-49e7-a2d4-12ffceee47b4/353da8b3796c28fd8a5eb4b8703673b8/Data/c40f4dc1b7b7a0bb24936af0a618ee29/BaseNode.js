...
let BaseNode = (() => {
    ...
    var BaseNode = _classThis = class extends _classSuper {
        ...
        onStart() {
            // Frame initializes on Start, so we configure it here
            if (this._frameComponent && !this._initialized) {
                // Make sure frame is visible after it initializes
                // Wait a frame for Frame to finish initializing
                this.createEvent("UpdateEvent").bind(() => {
                    if (this._frameComponent && typeof this._frameComponent.showVisual === 'function') {
