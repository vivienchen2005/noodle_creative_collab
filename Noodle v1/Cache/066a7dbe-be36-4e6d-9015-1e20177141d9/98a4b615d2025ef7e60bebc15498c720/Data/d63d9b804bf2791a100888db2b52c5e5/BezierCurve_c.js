...
// @input float controlPointSpread = 0.33 {"hint":"Control point spread - how far along the path the control points are positioned (0.3 = closer to ends, 0.5 = at midpoint)"}
...
awakeEvent.bind(() => {
    ...
    checkUndefined("controlPointSpread", []);
