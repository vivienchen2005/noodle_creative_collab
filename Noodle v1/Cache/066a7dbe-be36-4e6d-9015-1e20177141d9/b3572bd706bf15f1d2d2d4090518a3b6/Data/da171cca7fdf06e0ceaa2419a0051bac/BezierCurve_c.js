...
// @input float interpolationPoints = 50 {"hint":"Number of interpolation points along the curve (higher = smoother)"}
// @input float curveHeight = 0.3 {"hint":"Curve height offset - how much the curve arches upward (in meters)"}
