...
export class BezierCurve extends BaseScriptComponent {
    ...
    private initializeCurve(): void {
        if (!this.startPoint || !this.endPoint) {
            print(`BezierCurve: Cannot initialize - missing points. startPoint: ${!!this.startPoint}, endPoint: ${!!this.endPoint}`);
            return;
        }

        if (!this.lineMaterial) {
            print(`BezierCurve: Cannot initialize - lineMaterial is required but not set!`);
            return;
        }

        print(`BezierCurve: Initializing curve with startPoint: ${this.startPoint.name}, endPoint: ${this.endPoint.name}`);
        ...
        print(`BezierCurve: Curve initialized. Line created: ${!!this.line}`);
    }
