...
let PictureBehavior = (() => {
    ...
    var PictureBehavior = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.rightHandMeshObject = this.rightHandMeshObject;
            ...
            this.rightHandTipGlowMaterial = null;
            this.isRightHandPinching = false;
            this.pinchGlowInitialized = false;
            this.rightPinchDown = () => {
         ...
         */
        initializePinchVisualization() {
            try {
                let rightHandMeshObj = null;
                ...
                if (rightHandMeshObj) {
                    this.rightHandMesh = rightHandMeshObj.getComponent("RenderMeshVisual");
                    if (this.rightHandMesh) {
                        ...
                        if (materialCount > 1) {
                            ...
                            if (originalMaterial) {
                                ...
                                if (material0)
                                    this.rightHandMesh.addMaterial(material0);
                                this.rightHandMesh.addMaterial(this.rightHandTipGlowMaterial);
                                if (material2)
                                    this.rightHandMesh.addMaterial(material2);
        ...
        findHandMeshAlternative() {
            ...
            if (handMesh) {
                this.rightHandMesh = handMesh.getComponent("RenderMeshVisual");
