...
export class PictureBehavior extends BaseScriptComponent {
  ...
  @input
  @hint("Optional: Directly reference the right hand mesh SceneObject for pinch visualization. If not provided, will search automatically.")
  rightHandMeshObject: SceneObject | null = null
