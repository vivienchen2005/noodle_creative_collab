...
let PictureBehavior = (() => {
    ...
    var PictureBehavior = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.pinchIndicator = null;
            this.pinchGlow = null;
            this.pinchTrail = []; // Trail of visual indicators following the drawing
        ...
        createPinchVisualFeedback() {
            try {
                ...
                if (!this.pinchIndicator) {
                    ...
                    this.pinchGlow = this.pinchIndicator.createComponent("RenderMeshVisual");
                    if (this.pinchGlow) {
