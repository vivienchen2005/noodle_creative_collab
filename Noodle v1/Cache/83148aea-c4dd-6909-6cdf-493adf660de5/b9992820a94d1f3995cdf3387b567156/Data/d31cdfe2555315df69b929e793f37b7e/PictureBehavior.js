                            ...
                            captureFrameEvent.bind(() => {
                                ...
                                if (frameCount >= 3) {
                                    try {
                                        ...
                                        if (this._renderTarget && this._renderTarget.copyFrame && typeof this._renderTarget.copyFrame === 'function') {
                                            this._capturedStaticTexture = this._renderTarget.copyFrame();
