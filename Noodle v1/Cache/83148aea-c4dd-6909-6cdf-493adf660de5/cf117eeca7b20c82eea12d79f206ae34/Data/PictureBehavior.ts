            ...
            processEvent.bind(() => {
              ...
              if (frameCount >= 2) {
                try {
                  ...
                  // Create ProceduralTextureProvider from it to capture the static cropped result
                  ...
                  print("[PictureBehavior] Static cropped texture captured via ProceduralTextureProvider")
                } catch (e) {
