...
export class PictureBehavior extends BaseScriptComponent {
  ...
  private startTracking() {
    ...
    // Show pinch visual indicator when tracking starts
    if (this.pinchVisualIndicator) {
      this.pinchVisualIndicator.enabled = true
      print("[PictureBehavior] Pinch indicator shown")
    }
  ...
  private rightPinchUp = () => {
    ...
    // Hide pinch visual indicator when pinch ends
    if (this.pinchVisualIndicator) {
      this.pinchVisualIndicator.enabled = false
      print("[PictureBehavior] Pinch indicator hidden on pinch up")
    }
