                  ...
                  if (this._hiddenCaptureImage && this._hiddenCaptureImage.mainPass && this._hiddenCaptureObject) {
                    ...
                    renderEvent.bind(() => {
                      ...
                      if (renderFrameCount >= 1) {
                        ...
                        // This should capture the static CROPPED result (not full frame)
                        this.captureRendMesh.mainPass.captureImage = ProceduralTextureProvider.createFromTexture(this.screenCropTexture)

                        // Store the static camera frame (full frame, not cropped) for reference
                        ...
                        print("[PictureBehavior] The cropped region from the circle gesture is now available in captureImage")
