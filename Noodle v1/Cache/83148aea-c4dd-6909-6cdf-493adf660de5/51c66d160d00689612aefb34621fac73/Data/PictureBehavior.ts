      ...
      try {
        ...
        if (cropControl && cropControl.inputTexture) {
          ...
          if ((camTexture as any).copyFrame && typeof (camTexture as any).copyFrame === 'function') {
            ...
            // Then use ProceduralTextureProvider to capture it as static
            // The key: we create the ProceduralTextureProvider WHILE the static frame is the input
            let frameCount = 0
            ...
            processEvent.bind(() => {
              ...
              if (frameCount >= 2) {
                try {
                  ...
                  // Create ProceduralTextureProvider from it NOW (while static input is set)
                  ...
                  // This ensures the ProceduralTextureProvider captured the static version
                  cropControl.inputTexture = originalInput
                  
                  print("[PictureBehavior] Static cropped texture captured via ProceduralTextureProvider (created while static input was set)")
                } catch (e) {
