      ...
      try {
        ...
        if (cropControl && cropControl.inputTexture) {
          ...
          if ((camTexture as any).copyFrame && typeof (camTexture as any).copyFrame === 'function') {
            ...
            // Then use the hidden Image component to render it, and get a static copy
            let frameCount = 0
            ...
            processEvent.bind(() => {
              ...
              if (frameCount >= 2) {
                try {
                  ...
                  if (this._hiddenCaptureImage && this._hiddenCaptureImage.mainPass) {
                    ...
                    // Then we can get the texture from it
                    ...
                    renderEvent.bind(() => {
                      ...
                      if (renderFrameCount >= 1) {
                        ...
                        // Get the texture from it - this should be the rendered result
