                ...
                try {
                    ...
                    if (captureRendMesh && captureRendMesh.mainPass && captureRendMesh.mainPass.captureImage) {
                        ...
                        try {
                            ...
                            if (captureImage.texture) {
                                staticTexture = captureImage.texture;
                                print(`InputNodeImage: Got texture from captureImage.texture`);
                            }
                            else if (captureImage.getTexture && typeof captureImage.getTexture === 'function') {
                                staticTexture = captureImage.getTexture();
                                ...
                                if (screenCropTexture) {
                                    ...
                                    const cropControl = screenCropTexture.control;
                                    if (cropControl && cropControl.inputTexture) {
                                        ...
                                        if (inputTexture.copyFrame && typeof inputTexture.copyFrame === 'function') {
                                            // Copy the frame to get a static snapshot
                                            const copiedFrame = inputTexture.copyFrame();
