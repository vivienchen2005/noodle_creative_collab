...
export class InputNodeImage extends BaseScriptComponent {
    ...
    private onCaptureButtonClicked(): void {
        print("InputNodeImage: Capture button clicked - unhiding crop circle");

        // Check if we have a crop circle object
        if (!this.cropCircleObject) {
            print("InputNodeImage: ERROR - Crop Circle SceneObject not assigned! Please assign it in the inspector.");
            return;
        }

        // Unhide the crop circle object
        this.cropCircleObject.enabled = true;
        print("InputNodeImage: Crop circle unhidden");
