                    ...
                    if (captureRendMesh && captureRendMesh.mainPass && captureRendMesh.mainPass.captureImage) {
                        ...
                        try {
                            ...
                            if (captureImage.sourceTexture) {
                                const sourceTex = captureImage.sourceTexture;
                            ...
                            if (!staticTexture || staticTexture.copyFrame) {
                                // If captureImage is still live, try to get from hidden image
                                const hiddenImage = pictureBehavior._hiddenCaptureImage;
                                if (hiddenImage && hiddenImage.mainPass && hiddenImage.mainPass.baseTex) {
                                    ...
                                    if (hiddenTex.copyFrame && typeof hiddenTex.copyFrame === 'function') {
                                        staticTexture = hiddenTex.copyFrame();
