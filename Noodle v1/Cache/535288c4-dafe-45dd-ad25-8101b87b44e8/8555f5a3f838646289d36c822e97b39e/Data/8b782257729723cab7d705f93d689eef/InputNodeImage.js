                    ...
                    if (captureRendMesh && captureRendMesh.mainPass && captureRendMesh.mainPass.captureImage) {
                        ...
                        if (screenCropTexture) {
                            ...
                            try {
                                ...
                                if (screenCropTexture.copyFrame && typeof screenCropTexture.copyFrame === 'function') {
                                    staticTexture = screenCropTexture.copyFrame();
                                    ...
                                    if (cropControl && cropControl.inputTexture) {
                                        ...
                                        if (inputTexture && inputTexture.copyFrame && typeof inputTexture.copyFrame === 'function') {
                                            const copiedInput = inputTexture.copyFrame();
