...
export class InputNodeImage extends BaseScriptComponent {
     ...
     */
    private onCaptureComplete(capturedTextureProvider: ProceduralTextureProvider): void {
        ...
        try {
            ...
            if ((capturedTextureProvider as any).texture) {
                texture = (capturedTextureProvider as any).texture;
            } else if ((capturedTextureProvider as any).getTexture) {
                texture = (capturedTextureProvider as any).getTexture();
            } else {
