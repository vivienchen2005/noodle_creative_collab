...
// @input Asset.ObjectPrefab scannerPrefab {"hint":"Scanner prefab for crop circle capture (from Crop Circle.lspkg)"}
// @input Component.ScriptComponent pictureController {"hint":"PictureController component (optional - will search scene if not set)"}
// @input AssignableType_2 captureButton {"hint":"Capture button (will be created if not set)"}
