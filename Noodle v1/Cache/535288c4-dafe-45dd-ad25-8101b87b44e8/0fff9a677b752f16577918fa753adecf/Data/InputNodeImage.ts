...
export class InputNodeImage extends BaseScriptComponent {
    ...
    private onCaptureComplete(capturedTextureProvider: ProceduralTextureProvider): void {
        ...
        // Convert ProceduralTextureProvider to Texture
        // We need to get the texture from the provider
        try {
            // Get the texture from the procedural texture provider
            const texture = capturedTextureProvider.getTexture();
            if (texture) {
                ...
                print("InputNodeImage: WARNING - Could not get texture from ProceduralTextureProvider");
            }
        } catch (e) {
            print("InputNodeImage: ERROR - Failed to get texture from capture: " + e);
        }
    }
