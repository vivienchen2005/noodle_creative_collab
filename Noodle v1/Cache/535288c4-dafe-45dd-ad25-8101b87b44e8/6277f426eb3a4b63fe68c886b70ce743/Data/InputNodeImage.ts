...
export class InputNodeImage extends BaseScriptComponent {
    ...
    private setupCaptureButton(): void {
        ...
        if (this.captureButton) {
            ...
            // Set initial label
            if (this.captureButton.setLabel) {
    ...
    /**
     * Updates the capture button label
     */
    private updateCaptureButtonLabel(label: string): void {
        if (this.captureButton && this.captureButton.setLabel) {
            this.captureButton.setLabel(label);
            print(`InputNodeImage: Capture button label updated to "${label}"`);
        }
    }
