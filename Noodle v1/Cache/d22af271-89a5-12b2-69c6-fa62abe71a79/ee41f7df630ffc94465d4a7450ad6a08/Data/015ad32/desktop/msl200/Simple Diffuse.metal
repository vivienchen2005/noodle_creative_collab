...
//spec_const int sc_RayTracingShadowsLayout 95 0
...
constant int sc_RayTracingShadowsLayout [[function_constant(95)]];
...
float3 param_2=Output_N1.xyz;
float param_3=Output_N2;
float3 param_4=(*sc_set0.UserUniforms).Port_Emissive_N000;
float3 param_5=(*sc_set0.UserUniforms).Port_AO_N000;
...
param_2=fast::max(param_2,float3(0.0));
float4 param_6;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_6=float4(param_2,param_3);
}
else
{
float l9_5=0.0;
...
float4 l9_18=fast::max(param_8,float4(0.0));
float4 param_9=l9_18;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_21=fast::clamp(l9_20.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_21=fast::clamp(dot(l9_20.xyz,float3(l9_20.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_21=(1.0-dot(l9_20.xyz,float3(0.33333001)))*l9_20.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_21=(1.0-fast::clamp(dot(l9_20.xyz,float3(1.0)),0.0,1.0))*l9_20.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_21=fast::clamp(dot(l9_20.xyz,float3(1.0)),0.0,1.0)*l9_20.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_21=fast::clamp(dot(l9_20.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_21=dot(l9_20.xyz,float3(0.33333001))*l9_20.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_21=1.0-fast::clamp(dot(l9_20.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_22=l9_21;
float l9_23=l9_22;
float l9_24=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_23;
float3 l9_25=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_19.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_26=float4(l9_25.x,l9_25.y,l9_25.z,l9_24);
param_10=l9_26;
}
else
{
