...
float4 l9_75=l9_74;
Color_N3=l9_75;
float Luminance_N0=0.0;
Luminance_N0=dot(Color_N3.xyz,float3(0.29899999,0.58700001,0.114));
float Output_N1=0.0;
Output_N1=1.0-Luminance_N0;
float4 Value_N6=float4(0.0);
Value_N6=float4((*sc_set0.UserUniforms).Port_Value1_N006.x,(*sc_set0.UserUniforms).Port_Value1_N006.y,(*sc_set0.UserUniforms).Port_Value1_N006.z,Value_N6.w);
