    ...
    var Process3DNode = _classThis = class extends _classSuper {
        ...
        createTextConnection(sourceNode, promptNode, connectionId) {
            ...
            if (!startPoint) {
                ...
                print(`Process3DNode: Button exists: ${!!promptNode.getOutputButton()}, Button sceneObject: ${!!(promptNode.getOutputButton()?.sceneObject)}`);
                return null;
            }
            ...
            this.createEvent("UpdateEvent").bind(() => {
                ...
                if (!startPoint || !endPoint || isNull(startPoint) || isNull(endPoint)) {
                    ...
                    print(`Process3DNode: ERROR - startPoint or endPoint is null/invalid after waiting, cannot create BezierCurve`);
                ...
                try {
                    ...
                    if (!startTransform || !endTransform) {
                        ...
                        print(`Process3DNode: ERROR - startPoint or endPoint missing Transform, cannot create BezierCurve`);
                        callbackExecuted = true;
                        return;
                    }
                }
        ...
        createImageConnection(sourceNode, imageNode, connectionId) {
            ...
            if (!startPoint) {
                ...
                print(`Process3DNode: Button exists: ${!!imageNode.getOutputButton()}, Button sceneObject: ${!!(imageNode.getOutputButton()?.sceneObject)}`);
                return null;
            }
