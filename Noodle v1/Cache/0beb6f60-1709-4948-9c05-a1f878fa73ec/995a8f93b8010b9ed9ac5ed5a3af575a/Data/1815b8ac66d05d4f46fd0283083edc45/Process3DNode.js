...
let Process3DNode = (() => {
    ...
    var Process3DNode = _classThis = class extends _classSuper {
        ...
        createTextConnection(sourceNode, promptNode, connectionId) {
            ...
            // We need to set placeholders BEFORE component creation for validation
            let frameCount = 0;
            ...
            this.createEvent("UpdateEvent").bind(() => {
                ...
                try {
                    ...
                    if (bezierCurve) {
                        // Set placeholders immediately (required for validation)
                        ...
                        // Wait one more frame, then update to real objects
