...
export class ProcessImageGenNode extends BaseScriptComponent {
    ...
    @allowUndefined
    public generateButton: RectangleButton | null = null;
    ...
    private setupGenerateButton(): void {
        ...
        this.generateButton = this._generateButtonObject.createComponent(RectangleButton.getTypeName() as any) as RectangleButton;
        if (this.generateButton) {
            // RectangleButton uses _size instead of width
            const size = this.generateButton.sceneObject.getTransform().getLocalScale();
            this.generateButton.sceneObject.getTransform().setLocalScale(new vec3(6, 3, 3)); // Width, Height, Depth in cm
     ...
     */
    public getGenerateButton(): RectangleButton | null {
