...
let InputNode = (() => {
    ...
    var InputNode = _classThis = class extends _classSuper {
        ...
        setupPromptContent() {
            ...
            if (this.promptText) {
                print("InputNode: Prompt text already exists, skipping creation");
                return; // Already set
            }
        ...
        setupImageContent() {
            ...
            if (this.imageComponent) {
                print("InputNode: Image component already exists, skipping creation");
                return; // Already set
            }
        ...
        updateTitle() {
            ...
            if (this.titleText) {
                ...
                this.setupTitle();
                // After creating, update the text
                if (this.titleText) {
                    this.titleText.text = newTitle;
                    print(`InputNode: Title created and set to: "${newTitle}"`);
                }
            }
