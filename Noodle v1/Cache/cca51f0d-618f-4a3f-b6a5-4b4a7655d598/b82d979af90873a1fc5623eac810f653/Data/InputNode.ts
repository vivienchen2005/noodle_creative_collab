...
export class InputNode extends BaseScriptComponent {
    ...
    private setupTitle(): void {
        ...
        if (this.titleText) {
            ...
            const textPass = this.titleText.mainPass;
            if (textPass) {
                textPass.baseColor = new vec4(1, 1, 1, 1); // White color, fully opaque
            }
            
            print(`InputNode: Created title text component with text: "${this.titleText.text}"`);
        } else {
