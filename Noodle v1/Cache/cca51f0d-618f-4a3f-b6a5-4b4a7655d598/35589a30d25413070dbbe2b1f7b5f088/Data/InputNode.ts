...
export class InputNode extends BaseScriptComponent {
    ...
    private setupVoiceToText(): void {
        ...
        if (this.voiceToTextComponent && this.voiceButton && this.promptText) {
            ...
            this.voiceToTextComponent.toggleButton = this.voiceButton;
            
            // Connect transcription text to prompt text
            this.voiceToTextComponent.transcriptionText = this.promptText;
