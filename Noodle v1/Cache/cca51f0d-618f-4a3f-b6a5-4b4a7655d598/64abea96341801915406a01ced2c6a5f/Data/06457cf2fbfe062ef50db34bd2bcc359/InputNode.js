...
const TextInputField_1 = require("SpectaclesUIKit.lspkg/Scripts/Components/TextInputField/TextInputField");
/**
...
let InputNode = (() => {
    ...
    var InputNode = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.textInputField = this.textInputField;
        ...
        setupPromptContent() {
            ...
            this.textInputField = this._contentObject.createComponent(TextInputField_1.TextInputField.getTypeName());
            if (this.textInputField) {
