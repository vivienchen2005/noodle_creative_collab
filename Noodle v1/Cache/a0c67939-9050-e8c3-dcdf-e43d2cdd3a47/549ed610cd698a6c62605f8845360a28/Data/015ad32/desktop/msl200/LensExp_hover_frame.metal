...
//sampler sampler hover_frame_glow_texSmpSC 0:22
...
//texture texture2D hover_frame_glow_tex 0:4:0:22
...
//float3x3 hover_frame_glow_texTransform 4432
//float4 hover_frame_glow_texUvMinMax 4480
//float4 hover_frame_glow_texBorderColor 4496
...
//float Port_Position3_N005 4608
//float4 Port_Value3_N005 4624
//float4 Port_Value4_N005 4640
//float Port_Input1_N003 4656
//float depthRef 4660
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_hover_frame_glow_tex 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_hover_frame_glow_tex 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_hover_frame_glow_tex 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool UseViewSpaceDepthVariant 37 1
//spec_const bool hover_frame_glow_texHasSwappedViews 38 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_hover_frame_glow_tex 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_hover_frame_glow_tex 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int hover_frame_glow_texLayout 75 0
...
constant bool SC_USE_CLAMP_TO_BORDER_hover_frame_glow_tex [[function_constant(31)]];
constant bool SC_USE_CLAMP_TO_BORDER_hover_frame_glow_tex_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_hover_frame_glow_tex) ? SC_USE_CLAMP_TO_BORDER_hover_frame_glow_tex : false;
constant bool SC_USE_CLAMP_TO_BORDER_intensityTexture [[function_constant(32)]];
constant bool SC_USE_CLAMP_TO_BORDER_intensityTexture_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_intensityTexture) ? SC_USE_CLAMP_TO_BORDER_intensityTexture : false;
constant bool SC_USE_UV_MIN_MAX_hover_frame_glow_tex [[function_constant(33)]];
constant bool SC_USE_UV_MIN_MAX_hover_frame_glow_tex_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_hover_frame_glow_tex) ? SC_USE_UV_MIN_MAX_hover_frame_glow_tex : false;
constant bool SC_USE_UV_MIN_MAX_intensityTexture [[function_constant(34)]];
constant bool SC_USE_UV_MIN_MAX_intensityTexture_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_intensityTexture) ? SC_USE_UV_MIN_MAX_intensityTexture : false;
constant bool SC_USE_UV_TRANSFORM_hover_frame_glow_tex [[function_constant(35)]];
constant bool SC_USE_UV_TRANSFORM_hover_frame_glow_tex_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_hover_frame_glow_tex) ? SC_USE_UV_TRANSFORM_hover_frame_glow_tex : false;
...
constant bool hover_frame_glow_texHasSwappedViews [[function_constant(38)]];
constant bool hover_frame_glow_texHasSwappedViews_tmp = is_function_constant_defined(hover_frame_glow_texHasSwappedViews) ? hover_frame_glow_texHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_hover_frame_glow_tex [[function_constant(71)]];
constant int SC_SOFTWARE_WRAP_MODE_U_hover_frame_glow_tex_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_hover_frame_glow_tex) ? SC_SOFTWARE_WRAP_MODE_U_hover_frame_glow_tex : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture [[function_constant(72)]];
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_U_intensityTexture : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_hover_frame_glow_tex [[function_constant(73)]];
constant int SC_SOFTWARE_WRAP_MODE_V_hover_frame_glow_tex_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_hover_frame_glow_tex) ? SC_SOFTWARE_WRAP_MODE_V_hover_frame_glow_tex : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture [[function_constant(74)]];
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_V_intensityTexture : -1;
constant int hover_frame_glow_texLayout [[function_constant(75)]];
constant int hover_frame_glow_texLayout_tmp = is_function_constant_defined(hover_frame_glow_texLayout) ? hover_frame_glow_texLayout : 0;
...
float4 hover_frame_glow_texSize;
float4 hover_frame_glow_texDims;
float4 hover_frame_glow_texView;
float3x3 hover_frame_glow_texTransform;
float4 hover_frame_glow_texUvMinMax;
float4 hover_frame_glow_texBorderColor;
...
texture2d<float> hover_frame_glow_tex [[id(4)]];
...
sampler hover_frame_glow_texSmpSC [[id(22)]];
...
CoordsOut_N9=((UVCoord_N12-(*sc_set0.UserUniforms).Port_Center_N009)*(*sc_set0.UserUniforms).Port_Scale_N009)+(*sc_set0.UserUniforms).Port_Center_N009;
float4 Color_N1=float4(0.0);
int l9_1;
if ((int(hover_frame_glow_texHasSwappedViews_tmp)!=0))
{
int l9_2=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_6=l9_1;
int param_1=hover_frame_glow_texLayout_tmp;
int param_2=l9_6;
float2 param_3=CoordsOut_N9;
bool param_4=(int(SC_USE_UV_TRANSFORM_hover_frame_glow_tex_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).hover_frame_glow_texTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_hover_frame_glow_tex_tmp,SC_SOFTWARE_WRAP_MODE_V_hover_frame_glow_tex_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_hover_frame_glow_tex_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).hover_frame_glow_texUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_hover_frame_glow_tex_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).hover_frame_glow_texBorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.hover_frame_glow_tex.sample(sc_set0.hover_frame_glow_texSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
float param_18=(*sc_set0.UserUniforms).Port_Position3_N005;
float4 param_19=(*sc_set0.UserUniforms).Port_Value3_N005;
float4 param_20=(*sc_set0.UserUniforms).Port_Value4_N005;
param_12=fast::clamp(param_12,0.0,1.0);
float4 param_21;
if (param_12<param_14)
{
param_21=mix(param_13,param_15,float4(fast::clamp(param_12/param_14,0.0,1.0)));
}
else
{
if (param_12<param_16)
{
param_21=mix(param_15,param_17,float4(fast::clamp((param_12-param_14)/(param_16-param_14),0.0,1.0)));
}
else
{
if (param_12<param_18)
{
param_21=mix(param_17,param_19,float4(fast::clamp((param_12-param_16)/(param_18-param_16),0.0,1.0)));
}
else
{
param_21=mix(param_19,param_20,float4(fast::clamp((param_12-param_18)/(1.0-param_18),0.0,1.0)));
}
}
}
Value_N5=param_21;
...
float4 param_22=Value_N5;
float param_23=Output_N3.x;
...
float4 l9_79=fast::max(param_26,float4(0.0));
float4 param_27=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
