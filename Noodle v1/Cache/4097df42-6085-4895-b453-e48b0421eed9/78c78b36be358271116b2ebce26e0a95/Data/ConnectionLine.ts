...
export class ConnectionLine extends BaseScriptComponent {
    ...
    onStart() {
        print(`ConnectionLine: onStart - sourceNode: ${this.sourceNode ? this.sourceNode.name : 'null'}, targetNode: ${this.targetNode ? this.targetNode.name : 'null'}, material: ${this.lineMaterial ? 'SET' : 'MISSING'}`);
        ...
        if (this.sourceNode || this.targetNode) {
            ...
            print(`ConnectionLine: Initial connection points updated`);
        }
