...
let ConnectionLine = (() => {
    ...
    var ConnectionLine = _classThis = class extends _classSuper {
        ...
        onStart() {
            // Now create the BezierCurve component after everything is initialized
            if (!this.bezierCurve && this.startPointObject && this.endPointObject) {
                ...
                if (this.bezierCurve) {
                    // Set required inputs immediately
