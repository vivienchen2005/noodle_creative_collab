...
export class InteractiveBezierCurve extends BezierCurve {
    ...
    // Event callbacks
    public onDragStart: Event = new Event();
    public onDragEnd: Event = new Event();
    public onReleaseAtPosition: Event = new Event();
    ...
    onAwake() {
        ...
        if (!this.tempEndPoint) {
            this.tempEndPointObject = this.sceneObject.createChild("TempEndPoint");
        } else {
