// Note: BezierCurve should be copied or we need to reference it properly
// For now, we'll duplicate the necessary functionality
...
export class InteractiveBezierCurve extends BezierCurve {
    ...
    // Event callbacks
    public onDragStart: Event<void> = new Event();
    public onDragEnd: Event<void> = new Event();
    public onReleaseAtPosition: Event<vec3> = new Event();
